  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-green-100">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 border-t-4 border-green-500">
        ...
        <a
          href={`${import.meta.env.VITE_API_URL || 'http://localhost:5028'}/auth/google`}
          className="mt-3 flex items-center justify-center gap-3 w-full py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
        >
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          {' · '}
          <Link to="/register-organization" className="text-green-600 hover:text-green-700 font-medium">
